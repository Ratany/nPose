	...
	for(n = length - 1; n >= 0; n--)
		{
			...
			if(llList2String(in, n) == "")  //remove empty strings
				...
				if(type != TYPE_STRING)         //cast anything else to string
					{
